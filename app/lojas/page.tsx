    ...
    <main className="min-h-dvh bg-off-white flex flex-col">
      ...
      <section className="bg-verde-escuro pt-14 pb-20 px-6 sm:px-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="font-[family-name:var(--font-basement)] font-extrabold uppercase text-white text-4xl sm:text-5xl md:text-6xl leading-tight">
            Disponível em<br />
      ...
      <section className="max-w-xl mx-auto w-full px-5 -mt-5 pb-16">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <p className="font-[family-name:var(--font-basement)] font-bold text-verde-escuro text-base">
                    {store.name}
                  </p>
                  {store.featured && (
                    <span className="bg-limao text-verde-escuro text-[10px] font-[family-name:var(--font-basement)] font-bold px-2 py-0.5 rounded-full">
                      Recomendado
                    </span>
                  )}
                </div>
        ...
        <div className="text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 bg-[#25D366] text-white font-[family-name:var(--font-basement)] font-bold px-7 py-3.5 rounded-full hover:opacity-90 transition-opacity active:scale-[0.98] shadow-md shadow-green-900/20"
          >
