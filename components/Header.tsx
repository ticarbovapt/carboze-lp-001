  ...
  return (
    <header className="w-full bg-off-white border-b border-verde-escuro/10">
      <div className="max-w-6xl mx-auto px-5 py-3 flex items-center justify-between">
        ...
        {/* Nav */}
        <nav className="flex items-center gap-3 text-sm font-[family-name:var(--font-barlow)] font-semibold">
          {/* Preço mini */}
          <span className="hidden md:inline text-verde-escuro/60 text-xs font-normal">
            Pack 10 sachês —{" "}
