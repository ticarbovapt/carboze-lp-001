        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
          <div className="flex flex-col gap-3 font-[family-name:var(--font-archivo)]">
            ...
            <p className="text-white/35 text-sm">
              ...
              <a href="#" className="text-white/55 hover:text-limao transition-colors">Mercado Livre</a>
              {" · "}
              <a href="#" className="text-white/55 hover:text-limao transition-colors">Amazon</a>
            </p>
            <div className="flex gap-5 text-sm">
              ...
              <a href={SOCIAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" className="text-white/35 hover:text-limao transition-colors">YT: @carboze</a>
            </div>
          </div>
