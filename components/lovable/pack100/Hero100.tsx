...
export default function Hero100() {
  return (
    <section className="relative bg-verde-escuro py-24 md:py-36 overflow-hidden min-h-[580px] flex items-center">
      {/* Background — imagem de carro/veículo */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-60"
        style={{ backgroundImage: "url('/cz-vehicle-car.jpg')" }}
        aria-hidden="true"
      />
      {/* Gradient lateral para legibilidade */}
      <div
        className="absolute inset-0"
        style={{ background: "linear-gradient(100deg, rgba(9,58,48,0.96) 0%, rgba(9,58,48,0.72) 55%, rgba(9,58,48,0.25) 100%)" }}
        aria-hidden="true"
      />
