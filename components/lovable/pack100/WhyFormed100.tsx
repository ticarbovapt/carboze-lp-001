  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="space-y-5 font-[family-name:var(--font-archivo)] text-verde-escuro/65 text-base md:text-lg leading-relaxed mb-8">
          <p>
        ...
        <div className="bg-verde-escuro/5 border-l-4 border-verde-medio rounded-r-2xl p-6 max-w-2xl">
