...
export default function LovableHeader({ checkoutHref = "/#escolha-produto", hideNav = false, suporteHref, transparent = false, ctaLabel = "Quero economizar" }: LovableHeaderProps) {
